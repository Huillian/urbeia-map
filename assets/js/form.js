...
function placePinAt(lat, lng) {
  ...
  if (_marker) {
    ...
    _marker = L.marker([lat, lng], {
      draggable: true,
      icon: L.divIcon({
        html: `<div class="hive-box-pin form" style="width:30px;height:38px"><img src="assets/img/caixa-comunidade.png" alt="" width="30" style="width:30px;max-width:30px;height:auto"></div>`,
